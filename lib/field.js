...
Field.prototype.validate = function(value, strict) {
    ...
    if (!value){
        if (!!strict){
            if (this.required) {
                this.setError(AccountsTemplates.translate("Required Field"));
                this.setValidating(false);
                return AccountsTemplates.translate("Required Field");
            }
            else {
                this.setSuccess();
                this.setValidating(false);
    ...
    if (minLength && valueLength < minLength) {
        this.setError(AccountsTemplates.translate("Minimum required length: ") + minLength);
        this.setValidating(false);
        return AccountsTemplates.translate("Minimum required length: ") + minLength;
    }
    var maxLength = this.maxLength;
    if (maxLength && valueLength > maxLength) {
        this.setError(AccountsTemplates.translate("Maximum allowed length: ") + maxLength);
        this.setValidating(false);
        return AccountsTemplates.translate("Maximum allowed length: ") + maxLength;
    }
