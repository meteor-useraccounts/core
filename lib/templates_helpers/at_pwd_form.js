        ...
        if (AccountsTemplates.options.confirmPassword){
            ...
            if (password_again && password !== password_again){
                ...
                if (pwd_again.negativeValidation)
                    AccountsTemplates.state.fields.set("password_again", T9n.get(AccountsTemplates.texts.errors.pwdMismatch, markIfMissing=false));
                else
            ...
            if (new_password_again && new_password !== new_password_again){
                ...
                if (new_pwd_again.negativeValidation)
                    AccountsTemplates.state.fields.set("new_password_again", T9n.get(AccountsTemplates.texts.errors.pwdMismatch, markIfMissing=false));
                else
                    AccountsTemplates.state.form.set("error", [{
