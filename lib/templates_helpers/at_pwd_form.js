        ...
        if (AccountsTemplates.options.confirmPassword){
            ...
            if (password_again && password !== password_again){
                ...
                if (pwd_again.negativeValidation)
                    AccountsTemplates.getField("password_again").setStatus(
                        T9n.get(AccountsTemplates.texts.errors.pwdMismatch, markIfMissing=false)
                    );
                else
