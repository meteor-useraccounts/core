...
AT.prototype.init = function() {
    ...
    _.each(this._fields, function(field){
        ...
        if (positiveValidation === undefined)
            positiveValidation = gPositiveValidation;
        var negativeValidation = field.negativeValidation;
        if (negativeValidation === undefined)
            negativeValidation = gNegativeValidation;
        field.validation = positiveValidation || negativeValidation;
        ...
        console.log('contValidation  : ' + field.continuousValidation);
        console.log('negativeFeedback: ' + field.negativeFeedback);
        console.log('positiveFeedback: ' + field.positiveFeedback);
        */
