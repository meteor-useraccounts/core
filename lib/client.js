    ...
    Router.map(function() {
        ...
        if (signInRoutePath){
            this.route( AccountsTemplates.getConfig('signInRouteName') || 'signIn', {
                ...
                template: AccountsTemplates.getConfig('signInRouteTemplate') || 'fullPageAtForm',
        ...
        if (signUpRoutePath){
            this.route( AccountsTemplates.getConfig('signUpRouteName') || 'signUp', {
                ...
                template: AccountsTemplates.getConfig('signUpRouteTemplate') || 'fullPageAtForm',
                layoutTemplate: AccountsTemplates.getConfig('layoutTemplate') || Router.options.layoutTemplate,
                onBeforeAction: function(pause) {
                    if (Meteor.user()){
                        pause();
        ...
        if (AccountsTemplates.getConfig('showForgotPasswordLink')){
            ...
            if (forgotPwdRoutePath){
                this.route( AccountsTemplates.getConfig('forgotPwdRouteName') || 'atForgotPwd', {
                    ...
                    template: AccountsTemplates.getConfig('forgotPwdRouteTemplate') || 'fullPageAtForm',
                    layoutTemplate: AccountsTemplates.getConfig('layoutTemplate') || Router.options.layoutTemplate,
                    onBeforeAction: function(pause) {
                        if (Meteor.user()){
                            pause();
        ...
        this.route(AccountsTemplates.getConfig('resetPwdRouteName') || 'atResetPwd', {
            ...
            template: AccountsTemplates.getConfig('resetPwdRouteTemplate') || 'fullPageAtForm',
            layoutTemplate: AccountsTemplates.getConfig('layoutTemplate') || Router.options.layoutTemplate,
            onBeforeAction: function(pause) {
                if (Meteor.user()){
                    pause();
        ...
        this.route(AccountsTemplates.getConfig('enrollAccountRouteName') || 'atEnrollAccount', {
            ...
            template: AccountsTemplates.getConfig('enrollAccountRouteTemplate') || 'fullPageAtForm',
            layoutTemplate: AccountsTemplates.getConfig('layoutTemplate') || Router.options.layoutTemplate,
            onBeforeAction: function(pause) {
                if (Meteor.user()){
                    pause();
...
AT.prototype.postSignInRedirect = function(){
...
AT.prototype.postSignUpRedirect = function(){
