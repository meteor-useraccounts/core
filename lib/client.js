...
AT.prototype.init = function() {
    ...
    _.each(this._fields, function(field){
        ...
        console.log('positiveValidation  : ' + field.positiveValidation);
        console.log('negativeValidation  : ' + field.negativeValidation);
        console.log('positiveFeedback    : ' + field.positiveFeedback);
        console.log('negativeFeedback    : ' + field.negativeFeedback);
        console.log('continuousValidation: ' + field.continuousValidation);
