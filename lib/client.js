...
AT.prototype.init = function() {
    ...
    */
    ...
    var moveFieldAfterPwd = function(field_name) {
        ...
        if (fieldId !== -1 && fieldId !== (passwordId + 1)){
            // removes the field
            var field = AccountsTemplates._fields.splice(fieldId, 1)[0];
            // push the field right after the password position
            var new_fieldIds = AccountsTemplates.getFieldIds();
            var new_passwordId = _.indexOf(new_fieldIds, "password");
            AccountsTemplates._fields.splice(new_passwordId + 1, 0, field);
        }
    };
