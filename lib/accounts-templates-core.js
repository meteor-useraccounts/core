...
AT.prototype.init = function() {
    ...
    if (Meteor.isClient) {
        ...
        // TODO: add automatic fields here: 'password_again', 'username_email'
        ...
        if (this.getConfig('confirmPassword')){
            if (!pwdAgainPresent){
                ...
                pwdAgain.displayName = "Password (again)";
        ...
        _.each(this._fields, function(field){
            switch(field.name) {
                case 'email':
                    ...
                    break;
                case 'password':
                    field.visible = ['cpwd', 'enro', 'fpwd', 'rpwd', 'sgin', 'sgup'];
                    break;
                case 'password_again':
                    field.visible = ['cpwd', 'enro', 'fpwd', 'rpwd', 'sgup'];
                    break;
                case 'username':
                    field.visible = ['sgup'];
